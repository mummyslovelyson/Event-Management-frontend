...
export const getPublicOrganizerProfile = (id) => api.get(`/events/organizers/${id}`);
export const toggleEventReminder = (id, preferences) => api.post(`/events/${id}/reminders`, { preferences });
export const getEventReminderStatus = (id) => api.get(`/events/${id}/reminders`);
export const updateReminderPreferences = (id, preferences) => api.put(`/events/${id}/reminders/preferences`, { preferences });
