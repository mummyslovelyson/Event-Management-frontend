      ...
      <Link to={`/events/${event.id}`} className="block">
        <div className="relative aspect-[16/10] overflow-hidden bg-[#1C232B]">
          ...
          <motion.button
            ...
            disabled={loading}
            whileTap={{ scale: 0.8 }}
            className="absolute top-3 right-3 w-11 h-11 rounded-full bg-[#1C232B]/90 backdrop-blur-sm flex items-center justify-center text-[#EFEFF1] hover:scale-110 transition disabled:opacity-50"
        ...
        <div className="p-4">
          ...
          <div className="mt-4 pt-3 border-t border-[#262B2F] flex items-center justify-between">
            ...
            <span className="px-3 py-2.5 rounded-lg bg-white/10 text-white text-xs font-semibold group-hover:bg-white group-hover:text-[#1C232B] transition">
              View Details
            </span>
          </div>
        </div>
